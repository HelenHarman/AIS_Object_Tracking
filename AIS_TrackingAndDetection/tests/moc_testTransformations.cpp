/****************************************************************************
** Meta object code from reading C++ file 'testTransformations.h'
**
...
#error "The header file 'testTransformations.h' doesn't include <QObject>."
...
void *TransformationsTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Transformations"))
        return static_cast< Transformations*>(const_cast< TransformationsTest*>(this));
